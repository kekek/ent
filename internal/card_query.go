...
func (cgb *CardGroupBy) Strings(ctx context.Context) ([]string, error) {
	if len(cgb.fields) > 1 {
		return nil, errors.New("internal: CardGroupBy.Strings is not achievable when grouping more than 1 field")
	}
	var v []string
	if err := cgb.Scan(ctx, &v); err != nil {
		return nil, err
...
func (cgb *CardGroupBy) String(ctx context.Context) (_ string, err error) {
	...
	case 0:
		err = &NotFoundError{card.Label}
	default:
		err = fmt.Errorf("internal: CardGroupBy.Strings returned %d results when one was expected", len(v))
	}
	return
}
...
func (cgb *CardGroupBy) Ints(ctx context.Context) ([]int, error) {
	if len(cgb.fields) > 1 {
		return nil, errors.New("internal: CardGroupBy.Ints is not achievable when grouping more than 1 field")
	}
	var v []int
	if err := cgb.Scan(ctx, &v); err != nil {
		return nil, err
...
func (cgb *CardGroupBy) Int(ctx context.Context) (_ int, err error) {
	...
	case 0:
		err = &NotFoundError{card.Label}
	default:
		err = fmt.Errorf("internal: CardGroupBy.Ints returned %d results when one was expected", len(v))
	}
	return
}
...
func (cgb *CardGroupBy) Float64s(ctx context.Context) ([]float64, error) {
	if len(cgb.fields) > 1 {
		return nil, errors.New("internal: CardGroupBy.Float64s is not achievable when grouping more than 1 field")
	}
	var v []float64
	if err := cgb.Scan(ctx, &v); err != nil {
		return nil, err
...
func (cgb *CardGroupBy) Float64(ctx context.Context) (_ float64, err error) {
	...
	case 0:
		err = &NotFoundError{card.Label}
	default:
		err = fmt.Errorf("internal: CardGroupBy.Float64s returned %d results when one was expected", len(v))
	}
	return
}
...
func (cgb *CardGroupBy) Bools(ctx context.Context) ([]bool, error) {
	if len(cgb.fields) > 1 {
		return nil, errors.New("internal: CardGroupBy.Bools is not achievable when grouping more than 1 field")
	}
	var v []bool
	if err := cgb.Scan(ctx, &v); err != nil {
		return nil, err
...
func (cgb *CardGroupBy) Bool(ctx context.Context) (_ bool, err error) {
	...
	case 0:
		err = &NotFoundError{card.Label}
	default:
		err = fmt.Errorf("internal: CardGroupBy.Bools returned %d results when one was expected", len(v))
	}
	return
}
...
func (cs *CardSelect) Strings(ctx context.Context) ([]string, error) {
	if len(cs.fields) > 1 {
		return nil, errors.New("internal: CardSelect.Strings is not achievable when selecting more than 1 field")
	}
	var v []string
	if err := cs.Scan(ctx, &v); err != nil {
		return nil, err
...
func (cs *CardSelect) String(ctx context.Context) (_ string, err error) {
	...
	case 0:
		err = &NotFoundError{card.Label}
	default:
		err = fmt.Errorf("internal: CardSelect.Strings returned %d results when one was expected", len(v))
	}
	return
}
...
func (cs *CardSelect) Ints(ctx context.Context) ([]int, error) {
	if len(cs.fields) > 1 {
		return nil, errors.New("internal: CardSelect.Ints is not achievable when selecting more than 1 field")
	}
	var v []int
	if err := cs.Scan(ctx, &v); err != nil {
		return nil, err
...
func (cs *CardSelect) Int(ctx context.Context) (_ int, err error) {
	...
	case 0:
		err = &NotFoundError{card.Label}
	default:
		err = fmt.Errorf("internal: CardSelect.Ints returned %d results when one was expected", len(v))
	}
	return
}
...
func (cs *CardSelect) Float64s(ctx context.Context) ([]float64, error) {
	if len(cs.fields) > 1 {
		return nil, errors.New("internal: CardSelect.Float64s is not achievable when selecting more than 1 field")
	}
	var v []float64
	if err := cs.Scan(ctx, &v); err != nil {
		return nil, err
...
func (cs *CardSelect) Float64(ctx context.Context) (_ float64, err error) {
	...
	case 0:
		err = &NotFoundError{card.Label}
	default:
		err = fmt.Errorf("internal: CardSelect.Float64s returned %d results when one was expected", len(v))
	}
	return
}
...
func (cs *CardSelect) Bools(ctx context.Context) ([]bool, error) {
	if len(cs.fields) > 1 {
		return nil, errors.New("internal: CardSelect.Bools is not achievable when selecting more than 1 field")
	}
	var v []bool
	if err := cs.Scan(ctx, &v); err != nil {
		return nil, err
...
func (cs *CardSelect) Bool(ctx context.Context) (_ bool, err error) {
	...
	case 0:
		err = &NotFoundError{card.Label}
	default:
		err = fmt.Errorf("internal: CardSelect.Bools returned %d results when one was expected", len(v))
	}
	return
}
