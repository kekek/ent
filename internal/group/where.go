...
func Name(v int64) predicate.Group {
	return predicate.Group(func(s *sql.Selector) {
...
func NameEQ(v int64) predicate.Group {
	return predicate.Group(func(s *sql.Selector) {
		s.Where(sql.EQ(s.C(FieldName), v))
	})
}
...
func NameNEQ(v int64) predicate.Group {
	return predicate.Group(func(s *sql.Selector) {
...
func NameIn(vs ...int64) predicate.Group {
...
func NameNotIn(vs ...int64) predicate.Group {
	v := make([]interface{}, len(vs))
	for i := range v {
		v[i] = vs[i]
	}
...
func NameGT(v int64) predicate.Group {
	return predicate.Group(func(s *sql.Selector) {
...
func NameGTE(v int64) predicate.Group {
	return predicate.Group(func(s *sql.Selector) {
...
func NameLT(v int64) predicate.Group {
	return predicate.Group(func(s *sql.Selector) {
...
func NameLTE(v int64) predicate.Group {
	return predicate.Group(func(s *sql.Selector) {
