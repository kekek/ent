...
func (gu *GroupUpdate) SetName(i int64) *GroupUpdate {
	gu.mutation.ResetName()
	gu.mutation.SetName(i)
	return gu
}

// AddName adds i to the "name" field.
func (gu *GroupUpdate) AddName(i int64) *GroupUpdate {
	gu.mutation.AddName(i)
	return gu
}
...
func (gu *GroupUpdate) sqlSave(ctx context.Context) (n int, err error) {
	...
	if value, ok := gu.mutation.AddedName(); ok {
...
// SetName sets the "name" field.
func (guo *GroupUpdateOne) SetName(i int64) *GroupUpdateOne {
	guo.mutation.ResetName()
	guo.mutation.SetName(i)
	return guo
}

// AddName adds i to the "name" field.
func (guo *GroupUpdateOne) AddName(i int64) *GroupUpdateOne {
	guo.mutation.AddName(i)
	return guo
}
...
func (guo *GroupUpdateOne) sqlSave(ctx context.Context) (_node *Group, err error) {
	...
	if value, ok := guo.mutation.AddedName(); ok {
		_spec.Fields.Add = append(_spec.Fields.Add, &sqlgraph.FieldSpec{
			Type:   field.TypeInt64,
			Value:  value,
			Column: group.FieldName,
